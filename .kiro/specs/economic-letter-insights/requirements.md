...
1. WHEN the Backend initializes the AWS Bedrock client THEN the Backend SHALL use the AWS_DEFAULT_PROFILE environment variable set to sso-333910628864-AWSAdministratorAccess
